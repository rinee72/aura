# WP-0.4: 개발 환경 실행 스크립트
# Development 환경으로 Flutter 앱을 실행합니다.

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "AURA 개발 환경 실행" -ForegroundColor Cyan
...
if (-not (Test-Path $envFile)) {
    ...
    Write-Host "   .env.development.example을 복사하여 $envFile 파일을 생성하세요." -ForegroundColor Gray
...
Write-Host "   환경: Development" -ForegroundColor Gray
Write-Host "   Supabase 프로젝트: aura-mvp-dev" -ForegroundColor Gray
Write-Host ""
...
Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "개발 환경 실행 완료" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
